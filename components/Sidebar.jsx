  ...
  return ( 
    <div class="bg-white dark:bg-gray-900 mr-2">
      <div class="flex">
          <div class="h-screen">
              <nav class="mt-6 px-4">
                  <a class="hover:text-gray-800 text-gray-900 dark:text-gray-200 bg-gray-200 dark:bg-gray-500 dark:text-gray-400hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200 justify-start rounded-sm" href="#">
