function HomeCard(props) {
  return ( 
      <a href={props.link} className="mb-2 bg-gray-200 dark:bg-gray-900 border-2 border-gray-300 dark:border-gray-700  rounded-xl p-4 overflow-hidden shadow-xl flex items-center gap-4 max-w-xl h-24 card-left">
        <div className="mt-2">
